      ...
      <div class="card p-6">
        ...
        <div class="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-4">
          ...
          <div>
            ...
            <dd class="mt-1 text-sm text-gray-900 dark:text-white">{{ formatEnum(shipment.serviceType) }}</dd>
          </div>
          <div>
            <dt class="text-sm font-medium text-gray-500 dark:text-gray-400">Priority</dt>
            <dd class="mt-1 text-sm text-gray-900 dark:text-white">{{ formatEnum(shipment.priority) }}</dd>
          </div>
          <div>
