    ...
    >
        ...
        >
            ...
            <div class="px-6 pb-6">
                <div class="text-center">
                    ...
                    <div
                        ...
                        class="text-left bg-blue-50 dark:bg-blue-900/20 rounded-lg p-4 mb-4"
                    >
                        <h4
                        ...
                        <ul class="space-y-2">
                            ...
                            >
                                <span
                                    class="flex-shrink-0 w-5 h-5 bg-blue-200 dark:bg-blue-800 rounded-full flex items-center justify-center text-xs font-medium text-blue-600 dark:text-blue-400 mr-3 mt-0.5"
                                >
                                    {{ index + 1 }}
                                </span>
                                {{ step }}
                    ...
                    <div
                        v-if="showContact"
                        class="text-left bg-gray-50 dark:bg-gray-700 rounded-lg p-4 mb-4"
                    >
                        <h4
            ...
            <div class="px-6 pb-6 flex flex-col gap-3">
                ...
                <button @click="closeModal" class="w-full btn-outline">
                    {{ closeLabel }}
                </button>
            </div>
        </div>
